...
# Bigram approach:    RETURNS THE MOST APPEARED PHRASES
#ngrams(processed_text, n) - n being the no. of consecutive words
...
# Bag-of-Words approach:   RETURNS THE MOST APPEARED WORDS
bag_of_words = Counter(tokens)
most_common_three = bag_of_words.most_common(3)
print(f"\nThree most frequent words and number of occurrences according to Bag-of-Words:{most_common_three}")
