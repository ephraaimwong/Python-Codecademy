...
def get_cbows(sentence_lst, context_length):
  ...
  return cbows #list containing n(context_length) words left and right of val in no order 
...
def get_skip_grams(sentence_lst, context_length):
  ...
  return skip_grams #list containing n(context_length) words left and right of val in-order
...
# skip_grams is better for gensim modelling since the order of words gives context and is important 