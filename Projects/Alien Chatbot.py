...
class AlienBot(object):
    ...
    def __init__(self):
        #need to create a regex to re.match for bot replies to kick in 
        self.alienbabble = {
